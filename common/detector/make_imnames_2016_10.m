function [NameMatrix,sdata]=make_imnames_2016(filename,SCNNUM,readparms)
% [NameMatrix,specdata] = make_imnames_2016(filename,SCNNUM,readingparms)
...
%	readingpar (structure) with fields
...
%%      AREApath  area images path (top level) (not used), append with addnames2matrix
