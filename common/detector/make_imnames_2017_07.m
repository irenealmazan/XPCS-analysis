function [NameMatrix,sdata]=make_imnames_2017_07(filename,SCNNUM,readparms)
% [NameMatrix,specdata] = make_imnames_2017_07(filename,SCNNUM,readingparms)
...
%  (hardwire for pil_ since it doesn't seem to work automatically anymore from inputs
%
% OUTPUT (structure)
